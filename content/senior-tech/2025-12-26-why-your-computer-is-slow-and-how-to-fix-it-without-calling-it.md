...
3. Look at the **Status** column - anything that says "Enabled" is starting with your computer
4. Right-click things you don't need immediately and choose **Disable**
...
3. Look at what's starting automatically
4. Click the minus (-) button to remove things you don't need
...
2. Click **This PC**
3. Look at your C: drive - is the bar almost full (red)?

### How to Check (Mac)

1. Click the Apple menu
2. Go to **About This Mac** → **Storage**
3. Look at the colored bar - is it almost full?
...
**Check right now:**
1. Look at your Wi-Fi name - does it say "Linksys" or "NETGEAR-5G" or something generic?
2. Do you remember ever changing the router password from the default?
...
*Related reads:*
- *[5 Conversations to Have with Your Aging Parent About Online Safety (That Actually Work)](/senior-tech/2026-06-27-5-conversations-aging-parent-online-safety/)*
