...
<form id="newsletter-form" action="https://buttondown.com/api/emails/embed-subscribe/jonne" method="post" class="embeddable-buttondown-form" target="_top" style="margin:2em 0;padding:1.5em;background:#f7f7f7;border-radius:8px;border:1px solid #e0e0e0;">
...
<div id="newsletter-thankyou" style="display:none;text-align:center;padding:2em;background:#dcfce7;border-radius:8px;border:1px solid #bbf7d0;margin:2em 0;">
  <h2 style="margin-top:0;color:#166534;">🎉 You're subscribed!</h2>
  <p style="color:#166534;">Check your inbox for a confirmation email and your free cheat sheets.</p>
  <p style="margin-top:1em;"><a href="/newsletter/thank-you/" style="color:#2563eb;font-weight:bold;">Go to your welcome page →</a></p>
</div>
...
<script>
// Show inline thank-you message when Buttondown redirects back with ?subscribed=true
