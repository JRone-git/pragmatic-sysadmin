...
const TRANSLATIONS = {
  ...
  en: {
    ...
    meds: {
      ...
      alarmTitle: "⏰ Reminder for {name}",
      alarmHint: "Pick a time each day for Buddy to remind you about this medicine.",
      alarmTime: "Reminder time",
      alarmNote: "Buddy will send a notification when it's time. You can also just tap the green circle on this page when you've taken it.",
      alarmTimeRequired: "Please pick a time.",
      alarmSet: "✓ Alarm set for {time}",
      alarmSetNoNotify: "⏰ Alarm saved for {time} (notifications blocked — allow them in your browser settings)",
      alarmClear: "🔕 Remove this alarm",
      alarmCleared: "✓ Alarm removed",
      alarmDefaultBody: "Time to take your medicine. Tap here when you've taken it.",
      alarmUnsupported: "Your browser doesn't support notifications.",
      alarmDenied: "Notifications are blocked. Allow them in your browser settings to enable alarms."
    },
    notes: {
      title: "My Notes",
  ...
  es: {
    ...
    meds: {
      ...
      alarmTitle: "⏰ Recordatorio para {name}",
      alarmHint: "Elige una hora cada día para que Buddy te recuerde esta medicina.",
      alarmTime: "Hora del recordatorio",
      alarmNote: "Buddy enviará una notificación cuando sea la hora. También puedes tocar el círculo verde en esta página cuando la hayas tomado.",
      alarmTimeRequired: "Por favor, elige una hora.",
      alarmSet: "✓ Alarma puesta para las {time}",
      alarmSetNoNotify: "⏰ Alarma guardada para las {time} (notificaciones bloqueadas — permítelas en los ajustes de tu navegador)",
      alarmClear: "🔕 Quitar esta alarma",
      alarmCleared: "✓ Alarma quitada",
      alarmDefaultBody: "Es hora de tomar tu medicina. Toca aquí cuando la hayas tomado.",
      alarmUnsupported: "Tu navegador no soporta notificaciones.",
      alarmDenied: "Las notificaciones están bloqueadas. Permítelas en los ajustes de tu navegador para activar las alarmas."
    },
    notes: {
      title: "Mis Notas",
  ...
  fr: {
    ...
    meds: {
      ...
      alarmTitle: "⏰ Rappel pour {name}",
      alarmHint: "Choisissez une heure chaque jour pour que Buddy vous rappelle ce médicament.",
      alarmTime: "Heure du rappel",
      alarmNote: "Buddy enverra une notification quand ce sera l'heure. Vous pouvez aussi toucher le cercle vert sur cette page quand vous l'avez pris.",
      alarmTimeRequired: "Veuillez choisir une heure.",
      alarmSet: "✓ Alarme réglée pour {time}",
      alarmSetNoNotify: "⏰ Alarme enregistrée pour {time} (notifications bloquées — autorisez-les dans les paramètres de votre navigateur)",
      alarmClear: "🔕 Supprimer cette alarme",
      alarmCleared: "✓ Alarme supprimée",
      alarmDefaultBody: "C'est l'heure de prendre votre médicament. Appuyez ici quand vous l'avez pris.",
      alarmUnsupported: "Votre navigateur ne supporte pas les notifications.",
      alarmDenied: "Les notifications sont bloquées. Autorisez-les dans les paramètres de votre navigateur pour activer les alarmes."
    },
    notes: {
      title: "Mes Notes",
  ...
  de: {
    ...
    meds: {
      ...
      alarmTitle: "⏰ Erinnerung für {name}",
      alarmHint: "Wählen Sie eine tägliche Uhrzeit, zu der Buddy Sie an dieses Medikament erinnern soll.",
      alarmTime: "Erinnerungszeit",
      alarmNote: "Buddy sendet eine Benachrichtigung zur eingestellten Zeit. Sie können auch einfach den grünen Kreis auf dieser Seite antippen, wenn Sie es eingenommen haben.",
      alarmTimeRequired: "Bitte wählen Sie eine Uhrzeit.",
      alarmSet: "✓ Erinnerung für {time} gestellt",
      alarmSetNoNotify: "⏰ Erinnerung für {time} gespeichert (Benachrichtigungen blockiert — in den Browser-Einstellungen erlauben)",
      alarmClear: "🔕 Diese Erinnerung entfernen",
      alarmCleared: "✓ Erinnerung entfernt",
      alarmDefaultBody: "Es ist Zeit, Ihr Medikament einzunehmen. Tippen Sie hier, wenn Sie es eingenommen haben.",
      alarmUnsupported: "Ihr Browser unterstützt keine Benachrichtigungen.",
      alarmDenied: "Benachrichtigungen sind blockiert. Erlauben Sie sie in den Browser-Einstellungen, um Erinnerungen zu aktivieren."
    },
    notes: {
      title: "Meine Notizen",
  ...
  pt: {
    ...
    meds: {
      ...
      alarm: "Alarme",
      alarmNotify: "⏰ Hora de tomar {name} ({time})",
      alarmTitle: "⏰ Lembrete para {name}",
      alarmHint: "Escolha um horário todo dia para o Buddy te lembrar deste remédio.",
      alarmTime: "Horário do lembrete",
      alarmNote: "Buddy vai enviar uma notificação quando for a hora. Você também pode tocar no círculo verde nesta página quando tiver tomado.",
      alarmTimeRequired: "Por favor, escolha um horário.",
      alarmSet: "✓ Alarme configurado para {time}",
      alarmSetNoNotify: "⏰ Alarme salvo para {time} (notificações bloqueadas — permita nas configurações do navegador)",
      alarmClear: "🔕 Remover este alarme",
      alarmCleared: "✓ Alarme removido",
      alarmDefaultBody: "Hora de tomar seu remédio. Toque aqui quando tiver tomado.",
      alarmUnsupported: "Seu navegador não suporta notificações.",
      alarmDenied: "Notificações estão bloqueadas. Permita nas configurações do navegador para ativar alarmes."
    },
    notes: {
      title: "Minhas Notas",
  ...
  zh: {
    ...
    meds: {
      ...
      alarmTitle: "⏰ {name} 提醒",
      alarmHint: "选择每天提醒您吃药的时间。",
      alarmTime: "提醒时间",
      alarmNote: "到时间Buddy会发送通知。您也可以在吃完后点击此页面的绿色圆圈。",
      alarmTimeRequired: "请选择时间。",
      alarmSet: "✓ 已设置 {time} 提醒",
      alarmSetNoNotify: "⏰ 已保存 {time} 提醒（通知被阻止 — 请在浏览器设置中允许）",
      alarmClear: "🔕 移除此提醒",
      alarmCleared: "✓ 提醒已移除",
      alarmDefaultBody: "该吃药了。吃完后点击这里。",
      alarmUnsupported: "您的浏览器不支持通知。",
      alarmDenied: "通知被阻止。请在浏览器设置中允许通知以启用提醒。"
    },
    notes: {
      title: "我的备忘",
